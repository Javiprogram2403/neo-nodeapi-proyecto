...
const { crearVehiculo, obtenerVehiculos, eliminarVehiculo, actualizarVehiculo } = require("./controllers/vehiculo")
const { crearCliente, obtenerClientes, eliminarCliente, actualizarCliente } = require("./controllers/cliente")
